...
<input class="form-control" id="email2id" type="hidden" value="<?php echo $_SESSION['emailid'];?>">
                        ...
                        <div class="modal-content">
                            ...
                            <form method="post" role="form" id="contact_form">
                                <div class="modal-body">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12"><label class="text-dark"
                                                for="inputtitle">Event Title</label><input class="form-control py-3"
                                                id="inputtitle" name="inputtitle" type="text"
                                                placeholder="Enter Event title" /></div>
                                                 <div class="validate-title" style="color:red;"></div>
                                    </div>

                                     <div class="form-row">
                                        <div class="form-group col-md-12"><label class="text-dark"
                                                for="inputdesc">Event Description</label>
                                    <input class="form-control py-4" id="inputdesc" name="inputdesc" type="text" placeholder="Enter Event Description" rows="4"/></div>
                                     <div class="validate-desc" style="color:red;"></div>
                                    </div>
                                ...
                                <div class="form-group col-md-12">
                                    <label class="text-dark" for="inputEvents">Choose Field</label>
                                        <select class="form-control" style="height:3.125rem"
                                        id="inputEvents" name="inputEvents">
                               ...
                               <div class="validate-bookevent" style="color:red;"></div>
                                ...
                                <div class="form-row">
                                        ...
                                        <div class="validate-fail" style="color:red;"></div>
                        ...
                        minute.appendChild(opt);
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-success" id="create_me"
                                        style="margin: auto" onclick="registerevent();">Register Event</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="card-header">
                        <div class="row align-items-center justify-content-between">
                            ...
                            <div class="col-8 col-sm-auto ml-auto text-right pl-0">
                                <div>
                                    <button class="btn btn-falcon-default btn-sm" type="button" target="_blank"
                                    data-toggle="modal" data-target="#createbooking"><span class="fas fa-plus" data-fa-transform="shrink-3 down-2"></span><span class="d-none d-sm-inline-block ml-1">New</span></button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="falcon-data-table">
                            <table class="table table-sm mb-0 table-striped table-dashboard fs--1 data-table border-bottom border-200" data-options='{"searching":true,"responsive":false,"info":false,"lengthChange":false,"sWrapper":"falcon-data-table-wrapper","dom":"<&#39;row mx-1&#39;<&#39;col-sm-12 col-md-6&#39;l><&#39;col-sm-12 col-md-6&#39;f>><&#39;table-responsive&#39;tr><&#39;row no-gutters px-1 py-3 align-items-center justify-content-center&#39;<&#39;col-auto&#39;p>>","language":{"paginate":{"next":"<span class=\"fas fa-chevron-right\"></span>","previous":"<span class=\"fas fa-chevron-left\"></span>"}}}'>
                                <thead class="bg-200 text-900">
                                    <tr>
                                        <th class="align-middle sort" style="text-align: center">#</th>
                                        <th class="align-middle sort" style="text-align: center">Event ID</th>
                                        <th class="align-middle sort" style="text-align: center">Event Date</th>
                                        <th class="align-middle sort" style="text-align: center">Event Title</th>
                                        <th class="align-middle sort" style="text-align: center">Event Description</th>
                                        <th class="align-middle sort" style="text-align: center">Status</th>
                                       
                                        <th class="align-middle sort" style="text-align: center">Action</th>
                                ...
                                <?php 
                                 $con=new DbConnector();
               $sql = "SELECT * FROM `uevents` ORDER BY eventDate DESC" ;
               ...
               if($result){
                while($row = $result->fetch_assoc()) {
                    $i++;
                  $dbeventuniid=$row['eventuniid'];
                  $dbeventDate=$row['eventDate'];
                  $dbeventTitle=$row['eventTitle'];
                  $dbeventDesc=$row['eventDesc'];
                    
               ?>
                               
                                    <tr class="btn-reveal-trigger">
                                        <td class="py-2 align-middle" style="text-align: center"><?php echo($i); ?></td>
                                        <td class="py-2 align-middle" style="text-align: center" id="<?php echo($dbeventuniid); ?>"><?php echo($dbeventuniid); ?></td>
                                        <td class="py-2 align-middle" style="text-align: center"><?php echo($dbeventDate); ?></td>
                                        
                                         <td class="py-2 align-middle" style="text-align: center">
                                           <?php echo($dbeventTitle); ?>
                                        </td>
                                        <td class="py-2 align-middle" style="text-align: center">
                                           <?php echo($dbeventDesc); ?>
                                        </td>
                                        <td class="py-2 align-middle text-center fs-0 white-space-nowrap" style="text-align: center">
                                            <?php if($dbeventDate> Date('Y-m-d h:i:s', time())) { ?>
                                            <span class="badge badge rounded-capsule d-block badge-soft-success">Upcoming
                                                <span class="ml-1 fas fa-check" data-fa-transform="shrink-2"></span>
                                            </span>
                                        <?php } else if($dbeventDate< Date('Y-m-d h:i:s', time())) {?>
                                            <span class="badge badge rounded-capsule d-block badge-soft-success">Completed
                                                <span class="ml-1 fas fa-check" data-fa-transform="shrink-2"></span>
                                            </span>
                                        <?php } ?>
                                        </td>
                ...
                <a class="dropdown-item text-danger" style="cursor:pointer; " onclick="return deleteEvents('<?php echo($dbeventuniid); ?>')">Delete</a>
                                        </td>
    ...
    <script src="assets/js/manageEvents.js"></script>
