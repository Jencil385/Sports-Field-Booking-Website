                   ...
                   //connection for Database
                    $con=new DbConnector();
                     ...
                     $stmt = $con->prepare($my_query); 
                      ...
                      if($dbtable)
                      {
                       $sqlinsert="INSERT INTO `userfeedback`(`uemail`, `feedstar`, `feedanswer`, `feedexep`, `feedsugg`) VALUES (?,?,?,?,?)";
                       $stmt = $con->prepare($sqlinsert); 
                       $stmt->bind_param("sssss", $dbemail,$feedstar,$feedanswer,$feedexep,$feedsugg);
                       $dbemail=$email;
                       $feedstar=$flag;
                       $feedanswer=$prob;
                       $feedexep=$exp;
