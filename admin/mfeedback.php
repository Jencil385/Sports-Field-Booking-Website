...
<script>
                    ...
                    <div class="card-header">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-4 col-sm-auto d-flex align-items-center pr-0">
                                <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">User Feedbacks</h5>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-sm mb-0 table-striped table-dashboard fs--1 data-table border-bottom border-200" data-options='{"searching":true,"responsive":false,"info":false,"lengthChange":false,"sWrapper":"falcon-data-table-wrapper","dom":"<&#39;row mx-1&#39;<&#39;col-sm-12 col-md-6&#39;l><&#39;col-sm-12 col-md-6&#39;f>><&#39;table-responsive&#39;tr><&#39;row no-gutters px-1 py-3 align-items-center justify-content-center&#39;<&#39;col-auto&#39;p>>","language":{"paginate":{"next":"<span class=\"fas fa-chevron-right\"></span>","previous":"<span class=\"fas fa-chevron-left\"></span>"}}}'>
                                <thead class="bg-200 text-900">
                                    <tr>
                                        ...
                                        <th class="align-middle sort">Rate</th>
                                    
                                         <th class="align-middle sort">Experience</th>
                                        <th class="align-middle sort">Problem</th>
                                        <th class="align-middle sort">Suggestion</th>
                                        <th class="align-middle sort">Dated on</th>
               ...
               if($result){
                while($row = $result->fetch_assoc()) {
                  ...
                  $dbfeedID=$row['funiid'];
                  $dbuemail=$row['uemail'];
                  $dbfeedstar=$row['feedstar'];
                  $dbfeedexep=$row['feedexep'];
                  $dbfeedanswer=$row['feedanswer'];
                  $dbfeedsugg=$row['feedsugg'];
                   $dbsubdate=$row['subdate'];
               ...
               ?>
                                    ...
                                    <tr class="btn-reveal-trigger">
                                        ...
                                        <td class="py-2 align-middle"><?php echo($dbfeedstar); ?></td>
                                        
                                         <td class="py-2 align-middle">
                                           <?php echo($dbfeedexep); ?>
                                        </td>
                                        <td class="py-2 align-middle">
                                           <?php echo($dbfeedanswer); ?>
                                        </td>
                                        <td class="py-2 align-middle">
                                           <?php echo($dbfeedsugg); ?>
                                        </td>
                ...
                <a class="dropdown-item text-danger" style="cursor:pointer; " onclick="return deletefeedback('<?php echo($dbfeedID); ?>')">Delete</a>
                                        </td>
