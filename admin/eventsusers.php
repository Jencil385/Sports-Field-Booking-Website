...
<?php        
               $con=new DbConnector();
               $sqls = "SELECT * FROM `uevents` ORDER BY eventDate DESC" ;
               ...
               if($results)
               {
                ...
                { 
                  $i++;
                  $dbeventuniid=$rows['eventuniid'];
                  $dbeventDate=$rows['eventDate'];
                  $dbeventTitle=$rows['eventTitle'];
                  $dbeventDesc=$rows['eventDesc'];
                    ...
                    <div class="card-header">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-4 col-sm-auto d-flex align-items-center pr-0">
                                <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0"><?php echo $dbeventTitle ?></h5>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-sm mb-0 table-striped table-dashboard fs--1 data-table border-bottom border-200" data-options='{"searching":true,"responsive":false,"info":false,"lengthChange":false,"sWrapper":"falcon-data-table-wrapper","dom":"<&#39;row mx-1&#39;<&#39;col-sm-12 col-md-6&#39;l><&#39;col-sm-12 col-md-6&#39;f>><&#39;table-responsive&#39;tr><&#39;row no-gutters px-1 py-3 align-items-center justify-content-center&#39;<&#39;col-auto&#39;p>>","language":{"paginate":{"next":"<span class=\"fas fa-chevron-right\"></span>","previous":"<span class=\"fas fa-chevron-left\"></span>"}}}'>
                                <thead class="bg-200 text-900">
                                    <tr>
                                        ...
                                        <th class="align-middle sort">Team Name</th>
                                        <th class="align-middle sort">Captian Name</th>
                                        <th class="align-middle sort">Mobile</th>
        ...
        <?php 
            $con=new DbConnector();
              $sqlusr = "SELECT * FROM `eventregdetails` WHERE eventuniid=?" ;
               $stmtusr = $con->prepare($sqlusr);
               $stmtusr->bind_param("s",$dbeventuniid);
               $stmtusr->execute();
               ...
               if($resultusr){
                ...
                while($rowusr = $resultusr->fetch_assoc()) {
                    $j++;
                  $dbeventsuniid=$rowusr['eventuniid'];
                  $dbeventUsers=$rowusr['evnEmail'];
                  $dbTeamname=$rowusr['evnTeamname'];
                  $dbCapname=$rowusr['evnCapname'];
                  $dbcapmobile=$rowusr['evnMob'];
               ?>
                              
                                    <tr class="btn-reveal-trigger">
                                         
                                        <td class="py-2 align-middle"><?php echo($j); ?></td>
                                        
                                        <td class="py-2 align-middle">
                                           <?php echo($dbTeamname); ?>
                                        </td>
                                        <td class="py-2 align-middle"><?php echo($dbCapname); ?></td>
                                        
                                         <td class="py-2 align-middle">
                                           <?php echo($dbcapmobile); ?>
                                        </td>
                                        <td class="py-2 align-middle">
                                           <?php echo($dbeventUsers); ?>
                                        </td>
                                    </tr>
